...
export class ChatGateway implements OnGatewayConnection, OnGatewayDisconnect {
  ...
  async handleCommunitySendMessage(
    ...
    try {
      const dataToSend = {
        ...
        ...(payload.is_admin ? { admin_id: senderId } : { sender_id: senderId }),
      };
      ...
      return { message: 'Community message sent successfully', data: messageData };
    } catch (error) {
  ...
  async handleCommunityFetchMessages(@ConnectedSocket() client: Socket) {
    try {
      ...
      return { message: 'Community messages fetched successfully', data: messageData };
    } catch (error) {
  ...
  async handleCommunityFetchMoreMessages(
    ...
    try {
      ...
      return { message: 'More community messages fetched successfully', data: messageData };
    } catch (error) {
